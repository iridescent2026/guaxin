      ...
      <Card className="overflow-hidden">
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <div className="relative mb-8">
            {/* 签筒主体 - 木色/青绿色调 */}
            <div className="relative h-48 w-20 rounded-t-full rounded-b-lg bg-gradient-to-b from-teal-100 via-teal-50 to-emerald-100 shadow-lg border border-teal-200/50 overflow-hidden">
              {/* 签筒内壁 */}
